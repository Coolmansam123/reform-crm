...
def _mobile_home_page(br: str, bt: str, user: dict = None) -> str:
    ...
    body = (
        ...
        '<a href="/m/routes" class="mobile-cta mobile-cta-orange">'
        ...
        '</a>'
        + ('<a href="/m/map" class="mobile-cta mobile-cta-blue">'
        ...
        '<a href="/m/lead" class="mobile-link">\U0001f4cb Capture Lead</a>'
        '<a href="/m/recent" class="mobile-link">\u23f1\ufe0f Recent Logs</a>'
        + ('<a href="/m/map" class="mobile-link">\U0001f4cd Full Map</a>' if _is_admin(user) else '')
        + '<a href="/" class="mobile-link">\U0001f4bb Full Hub</a>'
        '</div>'
        '</div>'
    )
...
def _mobile_routes_dashboard_page(br: str, bt: str, user: dict = None) -> str:
    ...
    body = (
        ...
        '<div style="display:flex;align-items:center;gap:10px">'
        '<button class="m-theme-btn" onclick="mToggleTheme()" id="m-theme-btn"><span id="m-theme-icon">\U0001f319</span></button>'
        '<a href="/m" style="font-size:12px;color:var(--text3);text-decoration:none">\u2190 Home</a>'
        '</div>'
        '</div>'
        '<div class="mobile-body">'
        # Today's route CTA
        '<a href="/m/route" id="today-cta" class="mobile-cta mobile-cta-orange" style="margin-bottom:16px;display:none">'
        '<span class="mobile-cta-icon">\U0001f5fa\ufe0f</span>'
